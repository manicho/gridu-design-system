...
- [X] T001 Create `specs/00-analyze-existing-product/audit.md` with section headers:
...
- [X] T002 [P] Inventory gridu-web styling sources: confirm and list
...
- [X] T003 [P] Inventory gridu-landing styling sources: confirm and list
...
- [X] T004 [US1] Document gridu-web color findings in `audit.md` under `## gridu-web ###
...
- [X] T005 [US1] Document gridu-web typography findings in `audit.md` under `## gridu-web
...
- [X] T006 [US1] Document gridu-web spacing findings in `audit.md` under `## gridu-web ###
  ...
  instance.
- [X] T007 [US1] Document gridu-web component inventory in `audit.md` under `## gridu-web
...
- [X] T008 [US1] Document gridu-landing color findings in `audit.md` under `##
  gridu-landing ### Color`: extract actual values from `gridu-landing/src/styles/global.css`,
  citing that source
- [X] T009 [US1] Document gridu-landing typography findings in `audit.md` under `##
...
- [X] T010 [US1] Document gridu-landing spacing findings in `audit.md` under `##
...
- [X] T011 [US1] Document gridu-landing component inventory in `audit.md` under `##
...
- [X] T012 [US1] Write `## Cross-Surface Comparison` in `audit.md`: for each concept with
...
- [X] T013 [US2] Write `## Gaps` in `audit.md`: derive each gap (e.g. no documented type
...
- [X] T014 Run all six quickstart.md validation checks against the completed `audit.md` and
  fix any failing check directly in the document
- [X] T015 Re-run the `specs/00-analyze-existing-product/checklists/requirements.md`
